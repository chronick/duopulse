...
| 21 | musicality-improvements | Musicality Improvements Spike — investigate archetype tuning, hit budget, Gumbel temperature, guard rails to improve pattern variety and feel | pending | 2025-12-28 | 2025-12-29 | active/21-musicality-improvements.md |
| 22 | control-simplification | Control Simplification — remove reset mode, consolidate phrase/pattern length, merge voice coupling with balance, rethink swing | pending | 2025-12-29 | 2025-12-29 | active/22-control-simplification.md |
...
| 24 | power-on-behavior | Power-On Behavior — define boot defaults, reset to musical defaults on power cycle, read performance knobs on startup | pending | 2025-12-29 | 2025-12-29 | active/24-power-on-behavior.md |

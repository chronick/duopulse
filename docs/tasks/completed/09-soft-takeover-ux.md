...
## Requirements
- [x] **Value Scaling**: `SoftKnob` class should implement active scaling logic:
...
- [x] **Interaction Detection**: System needs to know *when* a knob is being turned to trigger the LED override.
- [x] **LED Feedback**:
...
2. [x] **Implement LED State Machine**:

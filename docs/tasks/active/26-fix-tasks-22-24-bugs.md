...
- [ ] All 3 critical bugs fixed (A1 ✅, A2 ✅, A3 ✅)
- [ ] All unit tests pass
- [ ] Firmware compiles clean
- [ ] Phase length auto-derivation works for all pattern lengths
- [ ] Config K4 and Config+Shift K1 have no effect
- [ ] Boot defaults consistent (no abrupt first-bar change)
- [ ] Ready for hardware validation with QA doc

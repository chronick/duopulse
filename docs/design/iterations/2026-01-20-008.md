...
**Next step recommendation**: Implement **Option A** (increase weight variance) as a simple, targeted fix. Create a new iteration (2026-01-20-009) to test this change.

...
## Recommendations for Four on Floor

**Option A**: Adjust preset reference to be more lenient
- Increase density tolerance: 0.15 → 0.25 (range 0.00-0.50)
- Reduce regularity requirement: 0.85 → 0.65

**Option B**: Algorithm investigation
- Investigate why euclidean doesn't produce perfect quarter-note spacing
- Consider a "four on floor mode" that forces specific hit positions

**Option C**: Accept limitation
- Four on Floor may not be achievable with current algorithm
